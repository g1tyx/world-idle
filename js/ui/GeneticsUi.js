...
"fixed"==o.type?m=1+r.getDisplayBonus():(m=100*r.getDisplayBonus(),u="%"),a.push({id:o.id,name:o.name,description:o.description,bonus:Math.round(1e4*m)/1e4+u,genes:r.getGenes()})}this.container.html(i({mutations:a})),this.tickYear(),this.container.find("#ascendButton").click(function(){if(confirm("Are you sure you want to ascend?")){var t=new e(c.main)
t.ascend()}})
var c=this
...
var e=new n(c.game)
if(!e.canMutate(t))return void alert("You don't have that many genes!")
e.mutate(t)
var i=c.container
